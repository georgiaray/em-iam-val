...
Usage:
    python regional_consistency.py --run_id xgb_04
    python regional_consistency.py --run_id xgb_04 --grouping R10
    python regional_consistency.py --run_id xgb_04 --use_ground_truth
"""
