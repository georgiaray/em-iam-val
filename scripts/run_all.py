...
Usage:
    python run_all.py --run_id xgb_04
    python run_all.py --run_id xgb_04 --percentile 5
    python run_all.py --run_id xgb_04 --no-sum-check
    python run_all.py --run_id xgb_04 --grouping R10
