...
Usage:
    python check_plausibility.py --run_id xgb_02
    python check_plausibility.py --run_id xgb_02 --percentile 5
    python check_plausibility.py --run_id xgb_02 --by_category
"""
